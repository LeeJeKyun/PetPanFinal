...
// 	console.log(${map.U_LONGITUDE} + " , " + ${map.U_LATITUDE})
...
// 	// -----------------------
	...
	var marker2 = new TooltipMarker(dkpos2, '우리집');
	marker1.setMap(map);
	marker2.setMap(map);
...
<div style = "text-align: right;">
	<a id = "toList" href = "./list">목록으로</a>
	<c:if test="${map.USERNO == userno }">
		<a id = "modifyInfoBtn" href = "./modifyinfo?hospitalno=${map.HOSPITALNO }">병원 정보 수정</a>
	</c:if>
</div>
	...
	<div id = "location">병원 위치 : <span>${map.ADDRESS } ${map.DETAILADDRESS }</span></div>
	<div id = "map-area"></div>
